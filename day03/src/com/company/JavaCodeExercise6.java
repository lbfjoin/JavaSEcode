 ...
 */
public class JavaCodeExercise6 {
...
//            if (guess > num)
//                System.out.println("大了" + num);
//            else if (guess < num)
//                System.out.println("小了" + num);
//            else {
...
//    }
    public static void main(String[] args) {
        ...
        //String转int类型
        String m = "5";
        int n =  Integer.valueOf(m);//会产生新对象
        int f = Integer.parseInt(m);//直接转
